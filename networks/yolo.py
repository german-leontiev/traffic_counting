...
class YoloBackbone(BaseBackbone):
    def __init__(
        ...
        self.model.classes = list(
            filter_classes) if filter_classes is not None else None  # (optional list) filter by class, i.e. = [0,
        # 15, 16] for persons, cats and dogs
    ...
    def detect(self, batch, device):
        ...
        for i, output in enumerate(outputs):
            ...
            for obj_dict in output:
                boxes.append([obj_dict['xmin'], obj_dict['ymin'], obj_dict['xmax'] - obj_dict['xmin'],
